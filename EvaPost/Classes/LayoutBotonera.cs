...
namespace EvaPost.Classes
{
    public class LayoutBotonera
    {
        ...
        public LinearLayout rootView(int rows, int columns)
        {
            ...
            lrl.SetBackgroundColor(new Android.Graphics.Color(Application.Context.GetColor(Resource.Color.colorPrimary)));
            lrl.WeightSum = rows;
        ...
        public LinearLayout createButton(int color)
        {
            ...
            layout.SetBackgroundColor(new Android.Graphics.Color(Application.Context.GetColor(color)));
            layouts.Add(layout);
            return layout;
        }
        ...
        public void SetOnPressedStyleToButton(LinearLayout layout, String label)
        {
            layout.Touch += (s, e) =>
            {
                ...
                {
                    Toast.MakeText(Application.Context, "PASA", ToastLength.Short ).Show();
                    layout.SetBackgroundColor(new Android.Graphics.Color(Application.Context.GetColor(Resource.Color.botoneraOnPressed)));
                    handled = true;
                }
